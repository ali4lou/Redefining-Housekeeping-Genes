...
| `bulk_tissue.py` | Classifies genes by tissue specificity and compares to developmental classes | Tissue-specific classifications | `files_tissue/` dataset (Hu et al., 2015; GEO **GSE62221**) |
