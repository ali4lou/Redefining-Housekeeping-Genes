...
@author: enrichment young genes S and hS
"""
...
dfs_molecular_func={}
dfs_cell_comp={}
#9.1.) ENRICHMENT S genes
label=['S_genes_gastrulation']
...
df_cell_comp.to_csv(path_save_data+"df_cell_comp_S_young_genes_gastrulation.csv", index=False)                
df_molecular_func.to_csv(path_save_data+"df_molecular_func_S_young_genes_gastrulation.csv", index=False)                
df_bio_process.to_csv(path_save_data+"df_bio_process_S_young_genes_gastrulation.csv", index=False)                
...
dfs_molecular_func={}
dfs_cell_comp={}
#9.1.) ENRICHMENT hS genes
label=['hS_genes_gastrulation']
for k in range(len(label)):
...
df_cell_comp.to_csv(path_save_data+"df_cell_comp_hS_young_genes_gastrulation.csv", index=False)                
df_molecular_func.to_csv(path_save_data+"df_molecular_func_hS_young_genes_gastrulation.csv", index=False)                
df_bio_process.to_csv(path_save_data+"df_bio_process_hS_young_genes_gastrulation.csv", index=False)                
